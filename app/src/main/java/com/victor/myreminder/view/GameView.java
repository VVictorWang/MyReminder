package com.victor.myreminder.view;
...
import com.victor.myreminder.activity.AlarmActivity;
import com.victor.myreminder.view.Card;
...
public class GameView extends GridLayout{
    ...
    public void initGame(){
        ...
        score=0;
        AlarmActivity.getAlarm().setScore(0);
        addBroad();
        addBroad();
    }
    ...
    private void completeGame() {
        ...
        if (isCompleted){
            AlertDialog.Builder builder = new AlertDialog.Builder(AlarmActivity.getAlarm());
            ...
            for (int i = 0; i < 4; i++) {
                for (int k = i+1; k < 4 ; k++) {
                    if(mCards[i][j].getNum()==0&&mCards[k][j].getNum()>0){
                        ...
                        AlarmActivity.getAlarm().setScore(score);
                        break;
                    }
                }
            }
